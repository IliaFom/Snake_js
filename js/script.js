class Field {
 ...
 class Snake {
   constructor() {
     ...
     document.querySelector('.high-score').textContent = `Highest Score: ${this.highScore}`;
   }
 ...
 function initGame() {
     if (!snake.isAlive) {
       alert(`Game Over! Your Score: ${snake.score}. Highest Score: ${snake.highScore}`);
       return snake.reset();
     }
     ...
     document.querySelector('.high-score').textContent = `Highest Score: ${snake.highScore}`;
